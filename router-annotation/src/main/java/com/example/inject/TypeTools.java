...
class TypeTools {
    ...
    public TypeTools(Types typeUtils,Elements elementUtils) {
        ...
        parcelableType = elementUtils.getTypeElement(Constants.PARCELABLE).asType();

        serializableType = elementUtils.getTypeElement(Constants.SERIALIZABLE).asType();
    ...
    public int convertType(TypeMirror typeMirror){
        switch (typeMirror.toString()){
            ...
            default:
                ...
                }else if (typeUtils.isSubtype(typeMirror,serializableType)){//TODO:????
