...
public class RationaleDialogConfig {
    ...
    AlertDialog createSupportDialog(Context context,RationaleDialogClickListener listener){
    ...
    android.app.AlertDialog createDialog(Context context,RationaleDialogClickListener listener){
